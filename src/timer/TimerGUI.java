...
public class TimerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Refresh Current Time");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new java.util.Date();
        jLabel2.setText("" + new java.util.Date());
    ...
    public void Timer() {
        ...
        timer = new javax.swing.Timer(1000, new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent ae) {
                i++;
                if (i <= 9) {
                    jLabel1.setText(m + ":" + "0" + String.valueOf(i) + " Sec.");
                }
                if (i >= 10) {
                    jLabel1.setText(m + ":" + String.valueOf(i) + " Sec.");
                }

                if (i == 60) {
                    i = 0;
                    m = m + 1;
                    jLabel1.setText(m + ":" + String.valueOf(i) + "0 Sec.");
                }
...
//            jLabel2.setText(sdf.format(cal.getTime()));
    ...
    public void confirm() {
        ...
        if (JOptionPane.showConfirmDialog(null, "Do you wish to keep counting?", "WARNING",
